...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--host' 'wasm32-unknown-wasi' '--build' 'arm64-apple-darwin20' '--with-static-linked-ext' '--with-ext=bigdecimal,cgi/escape,continuation,coverage,date,dbm,digest/bubblebabble,digest,digest/md5,digest/rmd160,digest/sha1,digest/sha2,etc,fcntl,fiber,gdbm,json,json/generator,json/parser,nkf,objspace,pathname,psych,racc/cparse,rbconfig/sizeof,ripper,stringio,strscan,monitor' 'LDFLAGS=-Xlinker -zstack-size=16777216' 'XLDFLAGS=/Users/katei/.ghq/github.com/ruby/wasi-vfs/target/wasm32-unknown-unknown/release/libwasi_vfs.a @/Users/katei/.ghq/github.com/kateinoigakukun/ruby.wasm/build/ext-build/pr5502-wasm32-unknown-wasi-full-js/js/link.filelist @/Users/katei/.ghq/github.com/kateinoigakukun/ruby.wasm/build/ext-build/pr5502-wasm32-unknown-wasi-full-js/witapi/link.filelist /Users/katei/.ghq/github.com/kateinoigakukun/ruby.wasm/build/ext-build/pr5502-wasm32-unknown-wasi-full-js/extinit.o' 'debugflags=-g0' '--disable-install-doc' 'build_alias=arm64-apple-darwin20' 'host_alias=wasm32-unknown-wasi'"
